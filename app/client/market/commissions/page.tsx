...
const ClientCommissionsPage = () => {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">My Transaction</h1>
        <p className="text-gray-600 mt-2">View and track your transaction history</p>
      </div>
          ...
          {myCommissions.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                You haven&apos;t made any trades yet. Start trading to see your transactions here.
              </p>
            </div>
          ) : (
            <>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {paginatedCommissions.map((commission) => (
                      <tr key={commission.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {commission.numberOfShares?.toLocaleString()}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
              ...
              {/* Pagination */}
              <div className="mt-6">
                <GeneralPagination datas={myCommissions} setPaginatedData={setPaginatedCommissions} />
              </div>
            </>
          )}
        </div>
