...
import CompanyDetailsModal from "@/components/pages/companies/company-details-modal"
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 mt-6">
        <div className="max-w-full mx-auto">
          ...
          <div className="w-full rounded shadow-sm transition-all duration-300 bg-white">
            {/* Search and Sort */}
            ...
            {filteredCompanies.length > 0 && (
              <CompaniesTable companies={paginatedCompanies} onViewDetails={handleViewDetails} />
            )}
