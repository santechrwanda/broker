...
const features = [
    {
        ...
        icon: (
            <FaChartLine className="w-12 h-12 mr-6 bg-green-100 p-3 rounded-md shrink-0 text-[#004f64]" />
        ),
    },
    {
        ...
        icon: (
            <FaUserShield className="w-12 h-12 mr-6 bg-green-100 p-3 rounded-md shrink-0 text-[#004f64]" />
        ),
    },
    {
        ...
        icon: (
            <FaComments className="w-12 h-12 mr-6 bg-green-100 p-3 rounded-md shrink-0 text-[#004f64]" />
        ),
    },
    {
        ...
        icon: (
            <FaExchangeAlt className="w-12 h-12 mr-6 bg-green-100 p-3 rounded-md shrink-0 text-[#004f64]" />
        ),
    },
    {
        ...
        icon: (
            <FaGlobeAfrica className="w-12 h-12 mr-6 bg-green-100 p-3 rounded-md shrink-0 text-[#004f64]" />
        ),
    },
    {
        ...
        icon: (
            <FaFileAlt className="w-12 h-12 mr-6 bg-green-100 p-3 rounded-md shrink-0 text-[#004f64]" />
        ),
    },
];
    ...
    return (
        <section className="my-32 max-w-7xl px-4 mx-auto" id="services">
            <div className="mb-16 max-w-2xl text-center mx-auto">
                <h2 className="md:text-4xl text-[#004f64] text-3xl font-extrabold mb-6">
                    What Makes Us Different
                </h2>
                <p className="mt-6 text-gray-600">
                    Built for Rwanda and beyond, our platform empowers brokers
                    and clients with the tools to trade smarter, communicate
                    better, and grow faster in a transparent, secure ecosystem.
                </p>
            </div>
