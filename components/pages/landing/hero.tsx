...
const Hero: React.FC = () => {
    ...
    return (
        <section
            className="relative md:max-h-[810px] max-md:min-h-[730px] max-md:bg-[#004f64] md:h-[calc(100vh-5rem)] max-md:h-f mt-1 overflow-hidden mb-16 shadow-md"
            id="home"
        >
            ...
            <Image
                ...
                alt=""
                fill
                className="object-cover max-md:hidden w-full md:max-h-[810px] h-full pointer-events-none select-none"
                style={{ zIndex: 10 }}
                priority
            />
                ...
                <div className="flex-1 md:pr-12 max-w-xl text-center md:text-left">
                    <h1 className="md:text-6xl text-4xl font-extrabold mb-6 md:!leading-[75px]">
                        ...
                        <span className="text-white/90">
                            all things{" "}
                            <span className="font-bold text-white">Stocks</span>
                        </span>
                    </h1>
                    <p className="text-white/80 mt-4 text-base md:text-lg max-w-2xl">
                        Step into the world of trading excellence and seize
                        every opportunity with our advanced platform, expert
                        guidance, and strategic insights for unrivaled financial
                        success.
                    </p>
            ...
            <div className="absolute inset-0 z-0 flex items-center justify-end max-md:justify-center bg-white max-md:relative">
                {images.map((img, idx) => (
                    <div
                        key={img.src}
                        ref={(el) => {
                        ...
                        className="absolute md:top-[80px] max-md:top-0 max-md:left-auto max-md:mx-2 w-[355px] h-[225px] md:w-[710px] md:h-[450px] flex items-center justify-center"
                    >
                        <Image
                            src={img.src}
                            alt={img.alt}
