...
const CallToActionBanner: React.FC = () => (
    <section
        className="bg-[#004f64] rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-center justify-between my-16 shadow-md"
        id="call-to-action"
    >
        <div className="flex-1 md:pr-12">
            ...
            <p className="text-lg text-blue-100 mb-8">
                Whether you&apos;re buying shares or browsing investment
                opportunities, Stock Broker connects you to trusted brokers and
                real-time market insights. Register today and take control of
